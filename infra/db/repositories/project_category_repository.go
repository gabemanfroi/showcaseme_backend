...
func (repository ProjectCategoryRepository) Update(id uint, dto *project_category.UpdateProjectCategoryDTO) (*project_category.ReadProjectCategoryDTO, error) {
	...
	updateProjectCategoryValuesFromDTO(&p, dto)
...
func updateProjectCategoryValuesFromDTO(model *models.ProjectCategory, dto *project_category.UpdateProjectCategoryDTO) {
	if dto.Name != nil {
		model.Name = *dto.Name
	}
}
